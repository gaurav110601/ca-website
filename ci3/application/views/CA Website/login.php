                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card mb-5">
                        <div class="card-body d-flex flex-column align-items-center">
                            ...
                            <form class="text-center" action="<?= base_url() ?>Ca/login" method="post">
                                ...
                                <div class="text-center" style="padding: 5px;"><a class="small" href="register">Don't have an account? Register!</a></div>
                            </form>
                        </div>
                    </div>
                </div>
